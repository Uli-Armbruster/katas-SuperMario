...
namespace SuperMarioRefactoring.Refactoring07
{
  public class SuperMarioSpecs
  {
    ...
    [Fact(Skip = "Konzept 'Yoshi' wird in der nächsten Iteration gefixt")]
    ...
    [Fact(Skip = "Konzept 'tot' wird in der nächsten Iteration gefixt")]
    public void Mario_findet_Yoshi_und_wird_zum_Reiter()
    {
      //wird in nächster Iteration gefixt
      //var mario = new SuperMario()
      //  .FindetYoshi()
